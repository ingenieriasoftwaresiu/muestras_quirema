        ...
        try {              
            ...
            if (strDatos == null){
               ...
               if (strCedulaUser.equals(strCedula)){
                   ...
                   out.println("</tr>");
                   out.println("<tr>");
                   out.println("<td class='LABELRESULT'>Identificación:</td>");
                   ...
                   out.println("<td class='LABELRESULT'>Nombre del cliente:</td>");
                   ...
                   out.println("</tr>");
                   out.println("<tr>");
                   out.println("<td class='LABELRESULT'>Estado de la muestra:</td>");
                   ...
                   out.println("</tr>");
                   out.println("<tr>");
                   out.println("<td class='LABELRESULT'>Comentario:</td>");
